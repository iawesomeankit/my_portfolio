  ...
  return (
    <section id="blogs">
      ...
      <div className="portfolio__labels">
        <a href="/#blogs/all" onClick={()=>handleClick("all")}>All</a>
        <a href="/#blogs/frontend" onClick={()=>handleClick("front-end")}> Frontend</a>
        <a href="/#blogs/backend" onClick={()=>handleClick("back-end")}>Backend</a>
        <a href="/#blogs/ui-ux" onClick={()=>handleClick("ui-ux")}>ui-ux</a>
        <a href="/#blogs/others" onClick={()=>handleClick("others")}>Others</a>
      </div>
      <Cardb data={data}/>
      <Link to="/blogs">
        <h3 className="allblogs">see all blogs<i className="fas fa-long-arrow-alt-right"></i>
      </h3>
      </Link>
    </section>
  );
